...
namespace RBT.Universal.CanEvalParameters
{
    ...
    public class ECUAndTrigger : TriggerBase, INotifyPropertyChanged, ICanEvalParameter
    {
        private ECUTrigger _trgA;
        private ECUTrigger _trgB;
        private int _trgID;
        ...
        public ECUAndTrigger(ECUTrigger trgA, ECUTrigger trgB)
        {
            InitParameter();
            TriggerA = trgA;
            TriggerB = trgB;
...
#pragma warning restore CS0109 // The member 'AndTrigger.TriggerID' does not hide an accessible member. The new keyword is not required.
        ...
        /// <summary>
        /// To reset ECUTrigger ID increment, should be called at each new test script
        /// </summary>
...
#pragma warning restore CS0109 // The member 'AndTrigger.TriggerName' does not hide an accessible member. The new keyword is not required.
        {
            get
            {
                return "ECUAndTrigger" + TriggerID;
            }
