...
namespace RBT.Universal.CanEvalParameters
{
    ...
    public class ECUDeltaTime : Model, ICanEvalParameter
    {
        ...
        public ECUDeltaTime(/*TriggerBase trgA, TriggerBase trgB,*/ string expDelta)
        {
            InitParameter();
            //TriggerA = trgA;
            //TriggerB = trgB;
        ...
        public int DeltaID
        {
            ...
            set
            {
                ...
                ((ListDependentParameter)EvalParameter).Name = "ECU_signal_Deltatime" + value;
